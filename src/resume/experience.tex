...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Built serious games to measure congnitive ability of dementia patients and the elderly}
        \item {Refactored the codebase written in Vanilla Javascript, resulting in a 85\% decrease in the applicaiton size}
      \end{cvitems}
    }
  \cventry
