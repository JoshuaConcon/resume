...
\begin{cventries}
  ...
  \cventry
    ...
    {
    \begin{cvitems}
      \item {Reduced submission time of advertising campaigns by 85\% by building an endpoint in Node to intake and validate campaign video and image assets according to the requirements of various demand-side platforms}
