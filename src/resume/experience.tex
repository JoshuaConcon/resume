...
\begin{cventries}
  \cventry
      ...
      {
        \begin{cvitems}
          \item {Configured and patched Db2 parameters to reduce historical log sizes of RDS instances by 61\%, resulting in a reduced base volume usage per instance by up to 3.8GB}
          \item {Refactored Db2 audit logging Integration Tests to reduce S3 Bucket usage by 98\% in the daily integration test runs and reducing the blast radius of S3 failures}
        \end{cvitems}
      }
  \cventry
  ...
  \cventry
    ...
    {Market Risk}
    {
      \begin{cvitems}
        ...
        \item {Launched new accessibility features in a P\&L web app with Angular, allowing traders to initiate trades more quickly}
      \end{cvitems}
    }
\end{cventries}
